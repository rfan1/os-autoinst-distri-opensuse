...
#
# Summary: Build nested L2 qcow2 image for cc libvirt and kvm tests
#          To simply the tests, we need disable firewalld, make a clean
#          network udev rule file, and permit root ssh
#
...
sub run {
    ...
    # Clean the network rule file, the the default NIC name can be re-used
